...
starting_dir = "/home/eriks/primatediversity/data/gVCFs_recalling_10_12_2024/LiftOver/{}"
# starting_dir_gvcf = "/home/eriks/primatediversity/data/gVCFs_recalling_10_12_2024/{}/gVCF/"
metadata_path = "~/primatediversity/data/gVCFs_recalling_10_12_2024_metadata/" # Performing all selection with Vasili's stats
zarr_dir = "human_ref_zarr_20x_inds/"
vasili_stats = "~/primatediversity/data/gVCFs_recalling_10_12_2024_metadata/plots/SupTable_Sample_Stats_wGT_QC.tsv"

def generate_zarr(all_chr, sample_names, out_path):
    inputs = [all_chr]
    o = out_path+"/call_genotype"
    outputs = [o]
